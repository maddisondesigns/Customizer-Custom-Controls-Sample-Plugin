	...
	public function skyrocket_register_sample_custom_controls( $wp_customize ) {
		...
		$wp_customize->add_control( new Skyrocket_Image_Radio_Button_Custom_Control( $wp_customize, 'sample_image_radio_button',
			array(
				...
				'choices' => array(
					'sidebarleft' => array(
						'image' => trailingslashit( plugin_dir_url( __DIR__ ) ) . 'images/sidebar-left.png',
						'name' => __( 'Left Sidebar', 'skyrocket' )
					),
					'sidebarnone' => array(
						'image' => trailingslashit( plugin_dir_url( __DIR__ ) ) . 'images/sidebar-none.png',
						'name' => __( 'No Sidebar', 'skyrocket' )
					),
					'sidebarright' => array(
						'image' => trailingslashit( plugin_dir_url( __DIR__ ) ) . 'images/sidebar-right.png',
		...
		$wp_customize->add_control( new Skyrocket_Image_checkbox_Custom_Control( $wp_customize, 'sample_image_checkbox',
			array(
				...
				'choices' => array(
					'stylebold' => array(
						'image' => trailingslashit( plugin_dir_url( __DIR__ ) ) . 'images/Bold.png',
						'name' => __( 'Bold', 'skyrocket' )
					),
					'styleitalic' => array(
						'image' => trailingslashit( plugin_dir_url( __DIR__ ) ) . 'images/Italic.png',
						'name' => __( 'Italic', 'skyrocket' )
					),
					'styleallcaps' => array(
						'image' => trailingslashit( plugin_dir_url( __DIR__ ) ) . 'images/AllCaps.png',
						'name' => __( 'All Caps', 'skyrocket' )
					),
					'styleunderline' => array(
						'image' => trailingslashit( plugin_dir_url( __DIR__ ) ) . 'images/Underline.png',
